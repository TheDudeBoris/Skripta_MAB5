...
\subsection{V\v eta}
Nech\'t $f_n(\x)\overset{\langle a,b\rangle}{\skonv}f(\x)$ a $\langle f|g\rangle_w.$ je skal\'arn\'i sou\v cin dle definice \ref{skalarnisoucin} pro $\CC(\langle a,b\rangle)$. Pak $f_n(\x)\nkonv(\x)$.\\

\NoProof

\subsection{V\v eta}
$f_n(\x)\overset{G}{\skonv}f(\x) \wedge \mu(G)<+\infty \Rightarrow f_n(\x)\overset{\LLL_2^{(w)}(G)}{\skonv}f(\x).$ Je-li v\'aha omezen\'a na $G.$\\

\Proof
\begin{itemize}
\item $\|f_n(\x)-f(\x)\|^2=\la f_n(\x)-f(\x)|f_n(\x)-f(\x)\ra=\int_G |f_n(\x)-f(\x)|^2~\dxx\leq\mu(G)\sup |f_n(\x)-f(\x)|^2\leq \dfrac{1}{2}\ep<\ep$
\item $(\forall\ep>0)(\exists n_0\in\N)\Bigg((n\leq n_0 \wedge \x\in G)\Rightarrow |f_n(\x)-f(\x)|<\sqrt{\dfrac{\ep}{2\mu(G)}}\Bigg)$
\end{itemize}
